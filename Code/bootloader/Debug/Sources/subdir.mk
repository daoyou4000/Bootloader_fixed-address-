...
Sources/bootloader.o: ../Sources/bootloader.c Sources/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32L431xx -DDEBUG -c -I../Includes -I../Includes/MCU_Core -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Sources/bootloader.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
